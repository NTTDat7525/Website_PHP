    ...
    <div class="w-full max-w-md bg-white rounded-lg shadow-md p-8">
        ...
        <form method="POST" action="{{ route('login.post') }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="username" class="w-full px-4 py-2 border rounded-lg focus:ring focus:ring-blue-300 focus:border-blue-500" required>
            </div>
            <div>
                <label class="block text-gray-700 font-medium mb-2">Mật khẩu</label>
                <input type="password" name="password" class="w-full px-4 py-2 border rounded-lg focus:ring focus:ring-blue-300 focus:border-blue-500" required>
            </div>
