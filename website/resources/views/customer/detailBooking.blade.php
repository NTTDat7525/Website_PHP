            ...
            <div class="flex justify-between items-center h-24">
                ...
                <div class="flex items-center gap-6 ml-4">
                    <a href="{{ route('customer.dashboard') }}"
                        class="text-2xl font-bold bg-gradient-to-r from-[#4647D3] to-[#8126CF] text-transparent bg-clip-text">
                        Grafit Lumina
                    </a>

                    <div class="hidden md:flex gap-8 ml-10">
                        <a href="#" class="text-gray-600 hover:text-gray-900 transition font-medium">Trang chủ</a>
                        <a href="{{ route('customer.booking.index') }}" class="text-blue-600 hover:text-blue-700 transition font-medium border-b-2 border-blue-600">Đặt bàn</a>
                        <a href="#" class="text-gray-600 hover:text-gray-900 transition font-medium">Ưu đãi</a>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-6 mr-4">
                    ...
                    <div class="relative group">
                        <button class="flex items-center gap-2 p-2 text-gray-600 hover:text-gray-900">
                            <i class="fas fa-user-circle text-2xl"></i>
                            <span class="text-sm font-medium">Duy Nguyễn</span>
                        </button>
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg hidden group-hover:block z-50 border border-gray-200">
                            ...
                            <form method="POST" action="{{ route('auth.logout') }}">
                                @csrf
                                <button type="submit"
                                    class="w-full text-left px-4 py-2 hover:bg-gray-100 rounded-b-lg text-red-600">
                                    Đăng xuất
                                </button>
                            </form>
                        </div>
